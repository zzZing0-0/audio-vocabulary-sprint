...
## v3.17 UI hierarchy refresh
- Speaker area keeps only speaker navigation and voice source.
- IPA colors sampled from user references: UK #fbd5e4, US #fbf6d5, generic IPA #d5f3e1.
- Empty Note collapses; existing Note opens by default and toggles.
- Reveal/PASS/AGAIN use text-only outline styling.
- Stats are Chinese and stacked.
- Progress advances in 10% rainbow milestones; a red flag marks exact progress.
