...
async function loadPronunciations(){
  try{
    const r=await fetch("data/pronunciations.json?v=3.28.1",{cache:"no-cache"});
...
document.getElementById("info").onclick=()=>{
 document.getElementById("panel").innerHTML=
   '<h2>规则 / 进度</h2>'+
   '<div class="listLinks infoPrimaryLinks"><a class="miniBtn linkBtn" href="active.html">⚠️ 查看钉子户</a><a class="miniBtn linkBtn" href="notes.html">📝 查看笔记</a><a class="miniBtn linkBtn" href="mastered.html">✅️ 查看已掌握</a><a class="miniBtn linkBtn" href="removed.html">❌ 查看已移除</a><button class="miniBtn dangerLite" id="panelReset" type="button">重置进度</button></div>'+
